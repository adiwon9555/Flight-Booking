...
<title>Flight Ticket Booking a Flat Responsive Widget Template
	:: w3layouts</title>
...
<body ng-controller="admin_ctrl" background="images/plane.png">
	...
	<div id="id01" class="modal fade"
		style="width: 80%; margin-left: 10%; margin-right: 10%; border: none;"
		...
		<form class="modal-content animate" action="/action_page.php">
			...
			<div class="container" style="background-color: #f1f1f1">
				<center>
					<p id="exampleModalLabel" style="font-size: 150%">
						<b>My Bookings</b>
					</p>
				</center>
				<br>
	...
	<div id="id02" class="modal fade"
		style="width: 40%; margin-left: 30%; margin-right: 10%; border: none;"
		aria-hidden="true" aria-labelledby="exampleModalLabel" tabindex="-1"
		role="dialog">
				...
				<form action="register_profile.htm" method=post
					...
					<div class="container">
						...
						<label><b>Password</b></label> <br> <input type="password"
							...
							} name="password" required> <label><b>Date of
								Birth</b></label> <br> <input type="date" id="dob"
							placeholder="Enter DOB" name="dob" value=${user.dob }  required>
						<br> <label><b>Mobile number</b></label> <input type="text"
							placeholder="Enter number" name="phone" value=${user.phone
							} required> <label><b>Gender</b></label> <input
							type=radio name=gender id="i" value=male> Male &nbsp;<input
							type=radio checked="checked" name=gender value=female>
						Female
			...
			<div class="container" style="background-color: #e8f4f3"
				...
				<center>
					<button type="button"
						onclick="document.getElementById('id02').style.display='none'"
						class="cancelbtn" data-dismiss="modal">Cancel</button>
					<button type="button" class="cancelbtn" onclick="edit_pro();">Edit</button>
				</center>
			</div>
		</form>
	</div>
	...
	<div id="navbar">
		...
		<a class="active" href="javascript:void(0)">Home</a> <a
			...
			style="width: auto;">My Bookings</a> <a href="javascript:void(0)">Contact
			Us</a>
		...
		<div class="dropdown" style="float: right; margin-right: 50px">
			...
			<button class="dropbtn">
				Hi ${user.name} <i class="fa fa-caret-down"></i>
			</button>

			<div class="dropdown-content">
				<a href="#" style="color: black;"
					onclick="document.getElementById('id02').style.display='block'"
					style="width:auto;">My profile</a> <a href="logout.htm"
						...
						<form action="Booking.jsp" method="post">
							<div class="from">
								...
								<input type="hidden" name="first" value="first"> <input
									list="source" style="padding: 10px 0; font-size: 15px"
									class="city1" placeholder="Type Departure City" name="source"
									required="" onkeydown="getCity(this)" autocomplete="off">
								<datalist id="source">
								</datalist>
							...
							<div class="to">
								...
								<input list="destination" style="padding: 10px; font-size: 15px"
									class="city2" placeholder="Type Destination City" required=""
									name="destination" onkeydown="getCity(this)" autocomplete="off">
							...
							<div class="date" style="margin-left: 12%; margin-top: 4%">
								<div class="depart">
									<h3>Depart</h3>
									<input type="date" style="width: 105%; font-size: 170%;"
										name=date> <span class="checkbox1"> <label
